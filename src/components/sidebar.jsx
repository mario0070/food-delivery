...
export default function Sidebar() {
  return (
    <div className="sidebar">
        ...
        <div className="links">
            <p className=""><a href="/vendor-dashboard" className='active'><i class="fa-solid fa-house"></i> Dashboard</a></p>
            <p className=""><a href="/chat"><i class="fa-solid fa-comments"></i> Chat</a></p>
